...
export function requestSearch(args = {}) {
  return (dispatch) => { // optionally you can have getState as the second argument
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      const doRequest = axios.post(`${window.app_config.api_url}/grant/search`, args, { withCredentials: true });
      doRequest.then(
        (res) => {
          dispatch({
            type: GRANTS_REQUEST_SEARCH_SUCCESS,
            data: res.data,
          });
          resolve(res);
        },
...
export function reducer(state, action) {
  switch (action.type) {
    case GRANTS_REQUEST_SEARCH_BEGIN:
    ...
    case GRANTS_REQUEST_SEARCH_SUCCESS:
    ...
    case GRANTS_REQUEST_SEARCH_FAILURE:
    ...
    case GRANTS_REQUEST_SEARCH_DISMISS_ERROR:
